...
public class GRPCClient {
    ...
    private static final long CYCLE_LIMIT = 50;
    private static final long FIRST_VALUE = 1;
    private static final long END_VALUE = 30;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        new GRPCClient().runClient(remoteNumberServiceStub, channel);

    }

    private void runClient(RemoteNumberServiceGrpc.RemoteNumberServiceStub remoteNumberServiceStub, ManagedChannel channel) throws InterruptedException {
